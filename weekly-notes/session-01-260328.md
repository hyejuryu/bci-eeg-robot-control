...
- 뇌 구조 및 기능 요약 정리
- Figure: session-01-eeg-bci-robot-pipeline.png
- Figure: [session-01-core-brain-function-structure.md]/https://github.com/hyejuryu/bci-eeg-robot-control/blob/main/docs/outputs/session-01-core-brain-function-structure.md
