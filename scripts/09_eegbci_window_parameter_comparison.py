# Session 14 baseline reproduction.
# This version initially preserves the Session 13
# configuration before adding parameter comparisons.
...
FIGURE_DIR = PROJECT_ROOT / "figures" / "session-1in4"
...
def main():
    ...
    if SAVE_OUTPUTS:
        raise RuntimeError(
            "Combined Session 14 output saving "
            "has not been implemented yet. "
            "Set SAVE_OUTPUTS to False."
        )
    ...
    print(
        "\nSession 14 configuration validation "
        "completed."
    )
