...
*A beginner’s reflection on why EEG-based brain-computer interfaces are less about reading thoughts and more about extracting reliable signal features.*

- Published on: Medium
- Medium link: [EEG Does Not Read the Brain: Why Features Matter in BCI](https://medium.com/@hyejuryuwork/eeg-does-not-read-the-brain-why-features-matter-in-bci-da6fc647426b)
- Date: 2026-04-29
- Related sessions:
...
1. Can I record EEG data with sufficient quality?
2. Can I observe basic physiological reactivity, such as eyes-closed versus eyes-open alpha changes?
3. Can I extract simple frequency-domain features such as alpha power and low beta power?
4. Can I compare those features across baseline and task conditions?
5. Can I use the resulting feature distribution to design a simple threshold rule?
6. Can that rule produce a stable enough command for Arduino-based robot control?
